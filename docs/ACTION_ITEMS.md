...
- 🟡 **B4 — Scale HSK 2** (đang chạy) bằng đúng pipeline coverage-driven.
  ...
  - 📌 **Refactor song song**: tách `course-lessons.js` → `js/data/course/course-data.js` (container) + `course-hsk1.js` + `course-hsk2.js` (xem plan tách — làm sau khi sync doc này).
