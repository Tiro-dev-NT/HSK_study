  ...
  window.CookieConsent = {
    ...
    _showBanner: function () {
      ...
      var html = ''
        ...
        + '      <p>Hanzi Genz dùng cookie cần thiết (đăng nhập, lưu tiến độ) — không thể tắt. '
        + '      Bạn có thể chọn bật/tắt analytics ẩn danh (giúp mình cải thiện app, KHÔNG có third-party tracking).</p>'
