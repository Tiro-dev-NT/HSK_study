...
var HSKK_ZHONGJI = {
  ...
  part1: [
    ...
    { id: 'zr17', zh: '我们打算周末一起去图书馆看书，顺便还几本借来的书。',
      py: 'Wǒmen dǎsuàn zhōumò yìqǐ qù túshūguǎn kàn shū, shùnbiàn huán jǐ běn jiè lái de shū.',
      vi: 'Chúng tôi định cuối tuần cùng đến thư viện đọc sách, tiện trả mấy quyển sách đã mượn.' },
    { id: 'zr18', zh: '虽然这个工作不太容易，但是只要努力，我相信一定能做好。',
      py: 'Suīrán zhège gōngzuò bú tài róngyì, dànshì zhǐyào nǔlì, wǒ xiāngxìn yídìng néng zuòhǎo.',
      vi: 'Tuy công việc này không dễ, nhưng chỉ cần cố gắng, tôi tin chắc chắn sẽ làm tốt.' },
    { id: 'zr19', zh: '因为路上堵车堵得很厉害，所以我比平时晚到了半个小时。',
      py: 'Yīnwèi lùshàng dǔchē dǔ de hěn lìhai, suǒyǐ wǒ bǐ píngshí wǎn dào le bàn ge xiǎoshí.',
      vi: 'Vì trên đường kẹt xe rất nặng, nên tôi đến muộn hơn bình thường nửa tiếng.' },
    { id: 'zr20', zh: '我觉得这本书不但内容丰富，而且语言也很容易懂。',
      py: 'Wǒ juéde zhè běn shū búdàn nèiróng fēngfù, érqiě yǔyán yě hěn róngyì dǒng.',
      vi: 'Tôi thấy quyển sách này không những nội dung phong phú, mà ngôn ngữ cũng rất dễ hiểu.' },
    { id: 'zr21', zh: '天气越来越冷了，大家出门的时候记得多穿一点儿衣服。',
      py: 'Tiānqì yuè lái yuè lěng le, dàjiā chūmén de shíhou jìde duō chuān yìdiǎnr yīfu.',
      vi: 'Thời tiết ngày càng lạnh, mọi người khi ra ngoài nhớ mặc thêm áo.' },
    { id: 'zr22', zh: '如果你有什么不明白的地方，可以随时打电话问我。',
      py: 'Rúguǒ nǐ yǒu shénme bù míngbai de dìfang, kěyǐ suíshí dǎ diànhuà wèn wǒ.',
      vi: 'Nếu bạn có chỗ nào không hiểu, có thể gọi điện hỏi tôi bất cứ lúc nào.' },
    { id: 'zr23', zh: '这家商店的衣服质量很好，价格也合理，所以生意一直不错。',
      py: 'Zhè jiā shāngdiàn de yīfu zhìliàng hěn hǎo, jiàgé yě hélǐ, suǒyǐ shēngyi yìzhí búcuò.',
      vi: 'Quần áo cửa hàng này chất lượng tốt, giá cả hợp lý, nên việc buôn bán luôn khá.' },
    { id: 'zr24', zh: '他一边听音乐一边做作业，结果用了比平时更长的时间。',
      py: 'Tā yìbiān tīng yīnyuè yìbiān zuò zuòyè, jiéguǒ yòng le bǐ píngshí gèng cháng de shíjiān.',
      vi: 'Anh ấy vừa nghe nhạc vừa làm bài tập, kết quả tốn nhiều thời gian hơn bình thường.' },
    { id: 'zr25', zh: '为了能说一口流利的汉语，我每天都坚持练习半个小时。',
      py: 'Wèile néng shuō yì kǒu liúlì de Hànyǔ, wǒ měi tiān dōu jiānchí liànxí bàn ge xiǎoshí.',
      vi: 'Để có thể nói một thứ tiếng Trung trôi chảy, mỗi ngày tôi đều kiên trì luyện nửa tiếng.' },
    { id: 'zr26', zh: '除了周末以外，他几乎每天晚上都要加班到很晚。',
      py: 'Chúle zhōumò yǐwài, tā jīhū měi tiān wǎnshang dōu yào jiābān dào hěn wǎn.',
      vi: 'Ngoài cuối tuần ra, hầu như tối nào anh ấy cũng phải tăng ca đến rất muộn.' },
    { id: 'zr27', zh: '这次旅行让我认识了很多新朋友，也看到了很多美丽的风景。',
      py: 'Zhè cì lǚxíng ràng wǒ rènshi le hěn duō xīn péngyou, yě kàndào le hěn duō měilì de fēngjǐng.',
      vi: 'Chuyến đi lần này giúp tôi quen nhiều bạn mới, cũng ngắm được nhiều phong cảnh đẹp.' },
    { id: 'zr28', zh: '妈妈做的菜越来越好吃了，每次回家我都能多吃一碗饭。',
      py: 'Māma zuò de cài yuè lái yuè hǎochī le, měi cì huí jiā wǒ dōu néng duō chī yì wǎn fàn.',
      vi: 'Món mẹ nấu ngày càng ngon, mỗi lần về nhà tôi đều ăn thêm được một bát cơm.' },
    { id: 'zr29', zh: '虽然我们只见过一次面，但是聊得非常愉快，好像老朋友一样。',
      py: 'Suīrán wǒmen zhǐ jiàn guò yí cì miàn, dànshì liáo de fēicháng yúkuài, hǎoxiàng lǎo péngyou yíyàng.',
      vi: 'Tuy chỉ gặp nhau một lần, nhưng trò chuyện rất vui, như thể bạn cũ vậy.' },
    { id: 'zr30', zh: '最近我养成了早睡早起的习惯，整个人的精神都好多了。',
      py: 'Zuìjìn wǒ yǎngchéng le zǎo shuì zǎo qǐ de xíguàn, zhěng ge rén de jīngshen dōu hǎo duō le.',
      vi: 'Gần đây tôi đã hình thành thói quen ngủ sớm dậy sớm, tinh thần khá hơn nhiều.' },
    { id: 'zr31', zh: '老师讲得非常清楚，所以就算是比较难的语法，我也很快就懂了。',
      py: 'Lǎoshī jiǎng de fēicháng qīngchu, suǒyǐ jiùsuàn shì bǐjiào nán de yǔfǎ, wǒ yě hěn kuài jiù dǒng le.',
      vi: 'Cô giáo giảng rất rõ, nên dù là ngữ pháp khó, tôi cũng nhanh chóng hiểu được.' },
    { id: 'zr32', zh: '他不但会说汉语，还会说英语和日语，真让人羡慕。',
      py: 'Tā búdàn huì shuō Hànyǔ, hái huì shuō Yīngyǔ hé Rìyǔ, zhēn ràng rén xiànmù.',
      vi: 'Anh ấy không chỉ biết nói tiếng Trung, còn biết tiếng Anh và tiếng Nhật, thật đáng ngưỡng mộ.' },
    { id: 'zr33', zh: '周末的时候，我喜欢一个人去咖啡馆，安安静静地看一会儿书。',
      py: 'Zhōumò de shíhou, wǒ xǐhuan yí ge rén qù kāfēiguǎn, ānʼānjìngjìng de kàn yíhuìr shū.',
      vi: 'Vào cuối tuần, tôi thích một mình đến quán cà phê, yên tĩnh đọc sách một lúc.' },
    { id: 'zr34', zh: '听说那家新开的饭店很受欢迎，我们最好提前打电话订位子。',
      py: 'Tīngshuō nà jiā xīn kāi de fàndiàn hěn shòu huānyíng, wǒmen zuìhǎo tíqián dǎ diànhuà dìng wèizi.',
      vi: 'Nghe nói nhà hàng mới mở đó rất được ưa chuộng, tốt nhất chúng ta nên gọi điện đặt chỗ trước.' },
    { id: 'zr35', zh: '这件事虽然花了不少时间，但是最后的结果让大家都很满意。',
      py: 'Zhè jiàn shì suīrán huā le bù shǎo shíjiān, dànshì zuìhòu de jiéguǒ ràng dàjiā dōu hěn mǎnyì.',
      vi: 'Việc này tuy tốn không ít thời gian, nhưng kết quả cuối cùng khiến mọi người đều hài lòng.' },
    { id: 'zr36', zh: '我打算趁这个假期好好休息，顺便把房间整理得干干净净。',
      py: 'Wǒ dǎsuàn chèn zhège jiàqī hǎohǎo xiūxi, shùnbiàn bǎ fángjiān zhěnglǐ de gāngānjìngjìng.',
      vi: 'Tôi định nhân kỳ nghỉ này nghỉ ngơi cho khỏe, tiện dọn phòng thật sạch sẽ.' },
    { id: 'zr37', zh: '随着天气慢慢变暖，公园里散步和锻炼的人也越来越多了。',
      py: 'Suízhe tiānqì mànmàn biàn nuǎn, gōngyuán lǐ sànbù hé duànliàn de rén yě yuè lái yuè duō le.',
      vi: 'Khi thời tiết dần ấm lên, người đi dạo và tập luyện trong công viên cũng ngày càng đông.' },
    { id: 'zr38', zh: '不管工作多忙，他都会抽出时间陪孩子一起读书、玩游戏。',
      py: 'Bùguǎn gōngzuò duō máng, tā dōu huì chōuchū shíjiān péi háizi yìqǐ dúshū, wán yóuxì.',
      vi: 'Dù công việc bận đến đâu, anh ấy đều dành thời gian cùng con đọc sách, chơi trò chơi.' },
    { id: 'zr39', zh: '第一次来到这座城市，我就被这里热闹又干净的街道吸引了。',
      py: 'Dì-yī cì lái dào zhè zuò chéngshì, wǒ jiù bèi zhèlǐ rènao yòu gānjìng de jiēdào xīyǐn le.',
      vi: 'Lần đầu đến thành phố này, tôi đã bị những con phố vừa náo nhiệt vừa sạch sẽ thu hút.' },
    { id: 'zr40', zh: '只要每天进步一点点，时间长了，你的汉语水平一定会有很大的提高。',
      py: 'Zhǐyào měi tiān jìnbù yìdiǎndiǎn, shíjiān cháng le, nǐ de Hànyǔ shuǐpíng yídìng huì yǒu hěn dà de tígāo.',
      vi: 'Chỉ cần mỗi ngày tiến bộ một chút, lâu dần, trình độ tiếng Trung của bạn nhất định sẽ nâng cao rất nhiều.' }
  ],
  ...
  part3: [
    ...
    { id: 'zo07', zh: '你认为读纸质书好还是看电子书好？请说说你的理由。',
      py: 'Nǐ rènwéi dú zhǐzhì shū hǎo háishi kàn diànzǐ shū hǎo? Qǐng shuōshuo nǐ de lǐyóu.',
      vi: 'Bạn cho rằng đọc sách giấy hay sách điện tử tốt hơn? Hãy nêu lý do của bạn.',
      hint: 'Thói quen · sức khỏe mắt · tiện lợi' },
    { id: 'zo08', zh: '有人说"失败是成功之母"，你同意这种说法吗？为什么？',
      py: 'Yǒu rén shuō "shībài shì chénggōng zhī mǔ", nǐ tóngyì zhè zhǒng shuōfǎ ma? Wèishénme?',
      vi: 'Có người nói "thất bại là mẹ thành công", bạn có đồng ý với cách nói này không? Vì sao?',
      hint: 'Bài học · kiên trì · ví dụ bản thân' },
    { id: 'zo09', zh: '你觉得学外语的时候，应该更重视听说还是读写？',
      py: 'Nǐ juéde xué wàiyǔ de shíhou, yīnggāi gèng zhòngshì tīngshuō háishi dúxiě?',
      vi: 'Khi học ngoại ngữ, bạn thấy nên coi trọng nghe nói hay đọc viết hơn?',
      hint: 'Mục đích · giao tiếp · cân bằng' },
    { id: 'zo10', zh: '你认为年轻人有必要学习做饭吗？请谈谈你的看法。',
      py: 'Nǐ rènwéi niánqīngrén yǒu bìyào xuéxí zuòfàn ma? Qǐng tántan nǐ de kànfǎ.',
      vi: 'Bạn cho rằng người trẻ có cần học nấu ăn không? Hãy nêu quan điểm của bạn.',
      hint: 'Sức khỏe · tiết kiệm · tự lập' },
    { id: 'zo11', zh: '有人喜欢提前做好计划，有人喜欢随时决定，你是哪一种人？',
      py: 'Yǒu rén xǐhuan tíqián zuò hǎo jìhuà, yǒu rén xǐhuan suíshí juédìng, nǐ shì nǎ yì zhǒng rén?',
      vi: 'Có người thích lập kế hoạch trước, có người thích quyết định tùy lúc, bạn thuộc kiểu nào?',
      hint: 'Tính cách · ưu điểm · ví dụ' },
    { id: 'zo12', zh: '你觉得手机给我们的生活带来了哪些方便和问题？',
      py: 'Nǐ juéde shǒujī gěi wǒmen de shēnghuó dài lái le nǎxiē fāngbiàn hé wèntí?',
      vi: 'Bạn thấy điện thoại mang lại cho cuộc sống chúng ta những tiện lợi và vấn đề gì?',
      hint: 'Liên lạc · thông tin · thời gian' },
    { id: 'zo13', zh: '你认为养宠物对一个人来说有什么好处？',
      py: 'Nǐ rènwéi yǎng chǒngwù duì yí ge rén lái shuō yǒu shénme hǎochù?',
      vi: 'Bạn cho rằng nuôi thú cưng có lợi ích gì đối với một người?',
      hint: 'Bầu bạn · trách nhiệm · tâm trạng' },
    { id: 'zo14', zh: '你觉得周末应该多休息，还是应该学点新东西？',
      py: 'Nǐ juéde zhōumò yīnggāi duō xiūxi, háishi yīnggāi xué diǎn xīn dōngxi?',
      vi: 'Bạn thấy cuối tuần nên nghỉ ngơi nhiều hay nên học thêm điều gì mới?',
      hint: 'Cân bằng · sở thích · nạp năng lượng' },
