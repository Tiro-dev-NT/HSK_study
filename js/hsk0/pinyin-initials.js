...
var HSK0Initials = (function() {
  ...
  function _renderResult() {
    ...
    if (section === 'recog' && passed) {
      ...
      nextBtn = '<div class="hsk0-box" style="background:var(--green-light);border-color:#6EE7B7;margin-top:16px"><div style="font-size:14px;font-weight:700;color:#065F46;text-align:center">🎉 Chúc mừng! Bạn đã hoàn thành Bài 2. Bài 3 (Vần 韵母) sẽ mở khoá sớm.</div></div>';
    }
