...
var Writing = (function () {
  ...
  async function _grade(deep) {
    ...
    var system = [
      ...
      '2. PHÂN BIỆT lỗi với "cách diễn đạt hay hơn". Ở trình độ thấp, câu đơn giản đúng ngữ pháp như 我吃饭 / 我打篮球 / 我看书 là ĐÚNG HOÀN TOÀN — KHÔNG được coi là lỗi chỉ vì có thể thêm lượng từ/bổ ngữ cho "tự nhiên hơn". Việc thêm 一顿/一场/了… hay đổi 吃饭→吃午饭 chỉ là nâng cao, KHÔNG phải lỗi, đừng đưa vào "errors".',
      '2b. Nếu một câu KHÔNG SAI nhưng bạn muốn gợi ý cách nói tự nhiên/hay hơn → BẮT BUỘC đưa vào "tips" (kèm chú thích "không sai, chỉ là gợi ý"), TUYỆT ĐỐI KHÔNG đưa vào "errors". "errors" chỉ chứa cái SAI thật sự.',
